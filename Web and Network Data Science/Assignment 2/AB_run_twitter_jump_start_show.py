# Bhattacharyya, PREDICT-452 Sect 55, Assignment 2
...
json_filename = 'AB_tweet_file.json'  

# name for text file for review of results
full_text_filename = 'AB_tweet_review_file.txt'  

# name for text from tweets
partial_text_filename = 'AB_tweet_text_file.txt'  
...
# Inserted my Twitter credentials  
# Sample usage of oauth() function
# twitter_api = oauth_login()    
def oauth_login():

    CONSUMER_KEY = 'ZFHe68cUttpSJWTXKk1e8jjFH'
    CONSUMER_SECRET = 'otRbV5ZBY2vLHkNixbNiUIcFCSInDi9WQOKkvR8XmXE1wttwS6'
    OAUTH_TOKEN = '959240808691093504-wAMIb8URTouLLK3H9Kdyl1IwJ3JbHjA'
    OAUTH_TOKEN_SECRET = 'MwW1MnlFCmGUyMn29mXTXaxfszWACg4DlWyPsvhZuex9q'
...
# this is the Chevrolet Bolt One example

twitter_api = oauth_login()   
print(twitter_api)  # verify the connection

q = "chevrolet bolt"  # one of many possible search strings
results = twitter_search(twitter_api, q, max_results = 200)  # limit to 200 tweets

# examine the results object... should be list of dictionary objects
